...
DISCOVER_RESULT=$OUTPUT_DIR/discover/taxonomy.json

FACTORIZE_RESULT_1=$OUTPUT_DIR/factorize/taxonomy_1.json
FACTORIZE_REPORT_1=$OUTPUT_DIR/factorize/report_1.json
FACTORIZE_RESULT_2=$OUTPUT_DIR/factorize/taxonomy_2.json
FACTORIZE_REPORT_2=$OUTPUT_DIR/factorize/report._2json

STRUCTURE_RESULT_1=$OUTPUT_DIR/structure/taxonomy_1.json
STRUCTURE_REPORT_1=$OUTPUT_DIR/structure/report_1.json
STRUCTURE_RESULT_2=$OUTPUT_DIR/structure/taxonomy_2.json
STRUCTURE_REPORT_2=$OUTPUT_DIR/structure/report_2.json
